	...
	renderTable() {
		...
		for (let i = 0; i < this.props.qset.dimensions.x; i++) {
			...
			for (let j = 0; j < this.props.qset.dimensions.y; j++) {
				...
				const innerData = (this.props.qset && this.props.qset.items[0].items[i] && this.props.qset.items[0].items[i][j])
				row.push(
					<Cell
