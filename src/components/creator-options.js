      ...
      <div>
        <div className="options-bar">
          ...
          <div className="style">
            ...
            <div id="spreadsheet-button" tabIndex={0} onKeyDown={(e) => {if (e.key === 'Enter') {this.props.useSpreadsheet()}}} onClick={this.props.useSpreadsheet} className={this.props.qset.spreadsheet ? "active" : ""}>
            ...
            <div id="table-button" tabIndex={0} onKeyDown={(e) => {if (e.key === 'Enter') {this.props.useTable()}}} onClick={this.props.useTable} className={!this.props.qset.spreadsheet ? "active" : "inactive"}>
              {this.props.qset.spreadsheet ?
          ...
          <div className="text">
            ...
            <div id="left-button" tabIndex={0} onKeyDown={(e) => {if (e.key === 'Enter') {this.props.useLeftAlign()}}} onClick={this.props.useLeftAlign} className={this.props.qset.left ? "active" : ""}>
            ...
            <div id="center-button" tabIndex={0} onKeyDown={(e) => {if (e.key === 'Enter') {this.props.useCenterAlign()}}} onClick={this.props.useCenterAlign} className={!this.props.qset.left ? "active" : ""}>
          ...
          <div className="header">
            ...
            <div id="header-button" tabIndex={0} onKeyDown={(e) => {if (e.key === 'Enter') {this.props.useHeader()}}} onClick={this.props.useHeader} className={this.props.qset.header ? "active" : ""}>
